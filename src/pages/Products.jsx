    ...
    () => [
      {
        ...
        title: 'Standard',
        category: 'Barquettes',
        image: 'http://www.devpack.com.tn/static/media/standard.cf74010e.jpg',
      ...
      },
      {
        ...
        category: 'Boucherie',
        image: 'http://www.devpack.com.tn/static/media/boucherie.2774d45f.webp',
      ...
      },
      {
        ...
        title: 'Primeur',
        category: 'Primeur',
        image: 'http://www.devpack.com.tn/static/media/bio.f99d3789.webp',
      ...
      },
      {
        ...
        category: 'Oeufs',
        image: 'http://www.devpack.com.tn/static/media/meat.6db8db8e.webp',
      ...
      },
      {
        ...
        image: 'http://www.devpack.com.tn/static/media/datte.796384de.webp',
      ...
      },
      {
        ...
        title: 'Dattes 500g',
        category: 'Spécialités',
        image: 'http://www.devpack.com.tn/static/media/datte_500.ed19ef0b.webp',
          ...
          {filtered.map((p) => (
            <motion.article key={p.id} initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-2xl overflow-hidden bg-white dark:bg-slate-900 border border-gray-200 dark:border-teal-500/20 shadow-sm">
              <div className="h-40 sm:h-44 bg-gray-100 dark:bg-slate-800 flex items-center justify-center">
                <img src={p.image} alt={p.title} loading="lazy" className="object-cover w-full h-40 sm:h-44" onError={(e) => { e.currentTarget.src = '/devpack-website/images/placeholder.png'; }} />
              </div>
